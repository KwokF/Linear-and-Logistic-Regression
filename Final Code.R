...
file <- "EOTST2112023_GROW.csv"

dat.grow <- read.csv(file, header = TRUE)
# Removing NSID
dat.grow <- dat.grow[, -1]
...
hist(dat.grow$W8GROW, main = "W8GROW", col = "lightblue", border = "black")
hist(log(dat.grow$W8GROW), main = "W8GROW", col = "lightblue", border = "black")
...
## Linear models of predictors that had a GVIF > 10
...
summary(lm(W8GROW ~ W8DWRK, data = dat.grow))

summary(lm(W8GROW ~ W8DACTIVITYC, data = dat.grow))
...
# Centering
dat.grow$cent.W1yschat1 <- with(dat.grow, W1yschat1 - mean(W1yschat1, na.rm = TRUE))
dat.grow$cent.W2ghq12scr <- with(dat.grow, W2ghq12scr - mean(W2ghq12scr, na.rm = TRUE))
dat.grow$cent.W6DebtattYP <- with(dat.grow, W6DebtattYP - mean(W6DebtattYP, na.rm = TRUE))
dat.grow$cent.W8DGHQSC <- with(dat.grow, W8DGHQSC - mean(W8DGHQSC, na.rm = TRUE))

grow.lm.cent <- lm(log(W8GROW) ~ cent.W1yschat1 + W1condur5MP + W1hea2MP 
                   + W1InCarHH + W1hous12HH + W1usevcHH  + W1hiqualdad + W1wrkfulldad
                   + W1wrkfullmum + W1ch0_2HH + W1ch3_11HH + W1ch12_15HH + W1ch16_17HH
                   + W1IndSchool + W1marstatmum + W1nssecfam  + W1ethgrpYP + W1heposs9YP
                   + W1hwndayYP + W1truantYP + W1alceverYP  + W1bulrc + W1disabYP 
                   + cent.W2ghq12scr + W2disc1YP + W2depressYP + W6JobYP + W6UnivYP  
                   + W6gcse + W6OwnchiDV + cent.W6DebtattYP + W6als
                   + W8DDEGP + cent.W8DGHQSC + W8DMARSTAT + W8DWRK
                   + W8CMSEX + W8TENURE + W8QMAFI
                   , data = dat.grow)

summary(grow.lm.cent)

# Standardising
dat.grow$std.W1yschat1 <- with(dat.grow, (W1yschat1 - mean(W1yschat1, na.rm = TRUE))/sd(W1yschat1, na.rm = TRUE))
dat.grow$std.W2ghq12scr <- with(dat.grow, (W2ghq12scr - mean(W2ghq12scr, na.rm = TRUE))/sd(W2ghq12scr, na.rm = TRUE))
dat.grow$std.W6DebtattYP <- with(dat.grow, (W6DebtattYP - mean(W6DebtattYP, na.rm = TRUE))/sd(W6DebtattYP, na.rm = TRUE))
dat.grow$std.W8DGHQSC <- with(dat.grow, (W8DGHQSC - mean(W8DGHQSC, na.rm = TRUE))/sd(W8DGHQSC, na.rm = TRUE))

grow.lm.std <- lm(log(W8GROW) ~ std.W1yschat1 + W1condur5MP + W1hea2MP 
                  + W1InCarHH + W1hous12HH + W1usevcHH  + W1hiqualdad + W1wrkfulldad
                  + W1wrkfullmum + W1ch0_2HH + W1ch3_11HH + W1ch12_15HH + W1ch16_17HH
                  + W1IndSchool + W1marstatmum + W1nssecfam  + W1ethgrpYP + W1heposs9YP
                  + W1hwndayYP + W1truantYP + W1alceverYP  + W1bulrc + W1disabYP 
                  + std.W2ghq12scr + W2disc1YP + W2depressYP + W6JobYP + W6UnivYP  
                  + W6gcse + W6OwnchiDV + std.W6DebtattYP + W6als
                  + W8DDEGP + std.W8DGHQSC + W8DMARSTAT + W8DWRK
                  + W8CMSEX + W8TENURE + W8QMAFI
                  , data = dat.grow)
...
# Checking outliers of final model
grow.lm.stats<-show_outliers(grow.lm, 5)
grow.lm.stats
...
no.outlier.dat.lm <- lm(log(W8GROW) ~  W1nssecfam + W1wrk1aMP + W1ethgrpYP + W6UnivYP*W8TENURE 
                        + W6OwnchiDV + W8DWRK*W8CMSEX + W8QMAFI + W8DMARSTAT  , data = no.outlier.dat)
summary(no.outlier.dat.lm)
...
file <- "EOTST2112023_PUSA.csv"

dat.pusa <- read.csv(file, header = TRUE)
# Removing NSID
dat.pusa <- dat.pusa[, -1]
# Making sure that the outcome is fully observed
...
hist(dat.pusa$W8PUSA, main = "W8PUSA", col = "lightblue", border = "black")
hist(log(dat.pusa$W8PUSA), main = "W8PUSA", col = "lightblue", border = "black")
...
# Centering
dat.pusa$cent.W1yschat1 <- with(dat.pusa, W1yschat1 - mean(W1yschat1, na.rm = TRUE))
dat.pusa$cent.W2ghq12scr <- with(dat.pusa, W2ghq12scr - mean(W2ghq12scr, na.rm = TRUE))
dat.pusa$cent.W6DebtattYP <- with(dat.pusa, W6DebtattYP - mean(W6DebtattYP, na.rm = TRUE))
dat.pusa$cent.W8DGHQSC <- with(dat.pusa, W8DGHQSC - mean(W8DGHQSC, na.rm = TRUE))

pusa.lm.cent <- lm(log(W8PUSA) ~ cent.W1yschat1 + W1condur5MP + W1hea2MP 
                   + W1InCarHH + W1hous12HH + W1usevcHH + W1hiqualmum + W1wrkfulldad + W1wrkfullmum 
                   + W1ch0_2HH + W1ch3_11HH + W1ch12_15HH + W1ch16_17HH + W1IndSchool + W1marstatmum  
                   + W1nssecfam + W1ethgrpYP + W1heposs9YP + W1hwndayYP + W1truantYP + W1alceverYP + W1bulrc
                   + W1disabYP + cent.W2ghq12scr + W2disc1YP + W2depressYP + W6JobYP + W6UnivYP
                   + W6gcse + W6als + W6OwnchiDV + cent.W6DebtattYP + W8DDEGP + cent.W8DGHQSC 
                   + W8DMARSTAT + W8DWRK + W8CMSEX + W8TENURE + W8QMAFI + W8GROW 
                   , data = dat.pusa)

summary(pusa.lm.cent)

# Standardising
dat.pusa$std.W1yschat1 <- with(dat.pusa, (W1yschat1 - mean(W1yschat1, na.rm = TRUE))/sd(W1yschat1, na.rm = TRUE))
dat.pusa$std.W2ghq12scr <- with(dat.pusa, (W2ghq12scr - mean(W2ghq12scr, na.rm = TRUE))/sd(W2ghq12scr, na.rm = TRUE))
dat.pusa$std.W6DebtattYP <- with(dat.pusa, (W6DebtattYP - mean(W6DebtattYP, na.rm = TRUE))/sd(W6DebtattYP, na.rm = TRUE))
dat.pusa$std.W8DGHQSC <- with(dat.pusa, (W8DGHQSC - mean(W8DGHQSC, na.rm = TRUE))/sd(W8DGHQSC, na.rm = TRUE))

pusa.lm.std <- lm(log(W8PUSA) ~ std.W1yschat1 + W1condur5MP + W1hea2MP 
                  + W1InCarHH + W1hous12HH + W1usevcHH + W1hiqualmum + W1wrkfulldad + W1wrkfullmum 
                  + W1ch0_2HH + W1ch3_11HH + W1ch12_15HH + W1ch16_17HH + W1IndSchool + W1marstatmum  
                  + W1nssecfam + W1ethgrpYP + W1heposs9YP + W1hwndayYP + W1truantYP + W1alceverYP + W1bulrc
                  + W1disabYP + std.W2ghq12scr + W2disc1YP + W2depressYP + W6JobYP + W6UnivYP
                  + W6gcse + W6als + W6OwnchiDV + std.W6DebtattYP + W8DDEGP + std.W8DGHQSC 
                  + W8DMARSTAT + W8DWRK + W8CMSEX + W8TENURE + W8QMAFI + W8GROW 
                  , data = dat.pusa)
...
no.outlier.dat.lm <- lm(log(W8PUSA)~ W1wrk1aMP + W8DDEGP + W8QMAFI 
                        , data = dat.pusa)
summary(no.outlier.dat.lm)
